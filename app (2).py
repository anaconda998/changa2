...
poem_parts = [
    ...
    "Now you’re leaving. And something inside me has quietly shifted… like saying goodbye not just to a friend, but to a possible future.",
    "Even now, I don’t seek answers — just one last promise:",
